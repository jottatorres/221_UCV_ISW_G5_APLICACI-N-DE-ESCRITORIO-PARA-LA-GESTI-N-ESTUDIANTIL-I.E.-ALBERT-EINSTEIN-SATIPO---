...
|----|-----------------|-------------|
|CU01|Registrar Usuario|El sistema permitira al Administrador registrar a los Docentes y Alumnos|
...
|IT03|I_Perfil_usuario|Ventana que muestra los datos del usuario y podra editar su informacion personal y el ID y contraseña|
|IT04|I_Curso|Ventana muestra información de la curso como: aula, horario, docente asignado y número de estudiantes|
|IT05|I_Nota|Ventana que muestra una formulario donde se podrá ingresar o visualizar las notas del estudiante|
